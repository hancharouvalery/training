...
export class MoviesDescribe extends Component {
    constructor(props){
      super(props);
    }
    render() {
            ...
            <div className='mdb-movies-describe__poster-and-text'>
                ...
                <div className='mdb-movies-describe__text'>
                {
                    this.props.movieArray
                        ...
                        .map((item)=>{
                            return <div className='mdb-movies-describe__overview' key={item.vote_average}>
                            <p className='mdb-movies-describe__title-text' key={item.id}>{item.title}</p>
