...
class Form extends Component {
    ...
    closeForm(e) {
      e.preventDefault();
      this.props.updateFormDisplay('none');
    }
    render() {
      return (
      <div className='mdb-form' style={{display: this.props.status}}>
        <div className='mdb-form__container'>
          <form className='mdb-from__content'>
            ...
            <div className='mdb-form__conrol-buttons'>
                <button className='mdb-form__add-button' disabled={this.validationForm()}>Add</button>
